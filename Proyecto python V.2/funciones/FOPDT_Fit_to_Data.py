...
Label(master, background="SkyBlue3", text="kp").grid(row=1)
Label(master, background="SkyBlue3", text="taup").grid(row=2)
Label(master, background="SkyBlue3", text="thetap").grid(row=3)
v1 = StringVar()
v2 = StringVar()
v3 = StringVar()
...
Label(master, background="SkyBlue3", textvariable=texto11).grid(row=6, column=1)


Label(master, background="SkyBlue3", font=(None, 15), text="FOPDT Fit to Data").place(relx=0.5, rely=0.03, anchor=CENTER)
Button(master, background="DodgerBlue2", text="Calculate"  , command=lambda: FOPDT_Fit_to_Data(v1.get(), v2.get(), v3.get())).grid(row=5)
master.mainloop()
