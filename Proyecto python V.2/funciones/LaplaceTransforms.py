...
Label(master, background="SkyBlue3", text="K").grid(row=2)
Label(master, background="SkyBlue3", text="tau").grid(row=3)
...
Label(master, background="SkyBlue3", font=(None, 15), text="Laplace Transforms").place(relx=0.5, rely=0.03, anchor=CENTER)
Button(master, background="DodgerBlue2", text="Calculate" , command=lambda: LaplaceTransforms(v1.get(), v2.get(), v3.get(), v4.get())).grid(row=6)
master.mainloop()
