...
Label(master, background="SkyBlue3", text="U").grid(row=1)
Label(master, background="SkyBlue3", text="X").grid(row=2)
v1 = StringVar()
v2 = StringVar()
...
Label(master, background="SkyBlue3", textvariable=texto6).grid(row=6)
Label(master, background="SkyBlue3", textvariable=texto7).grid(row=7)
Label(master, background="SkyBlue3", textvariable=texto8).grid(row=8)
Label(master, background="SkyBlue3", textvariable=texto9).grid(row=9)
Label(master, background="SkyBlue3", textvariable=texto10).grid(row=10)
Label(master, background="SkyBlue3", textvariable=texto11).grid(row=11)
Label(master, background="SkyBlue3", textvariable=texto12).grid(row=12)
Label(master, background="SkyBlue3", textvariable=texto13).grid(row=13)

Label(master, background="SkyBlue3", font=(None, 15), text="Linearization").place(relx=0.5, rely=0.03, anchor=CENTER)
Button(master, background="DodgerBlue2", text="Calculate" , command=lambda: Linearization(v1.get(), v2.get())).grid(row=5)
mainloop()
