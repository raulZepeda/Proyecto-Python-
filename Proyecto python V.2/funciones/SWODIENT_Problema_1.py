...
Label(master, background="SkyBlue3", font=(None, 15), text="Solve With ODEINT").place(relx=0.5, rely=0.1, anchor=CENTER)
Button(master, background="DodgerBlue2", text="Calculate", command=lambda: SWODIENT_Problema_1(v1.get(), v2.get(), v3.get())).grid(row=5)
