...
Label(master, background="SkyBlue3", text="constant (2)").grid(row=6)
Label(master, background="SkyBlue3", text="constant (5)").grid(row=7)
v1 = StringVar()
v2 = StringVar()
v3 = StringVar()
v4 = StringVar()
...
Button(master, background="DodgerBlue2", text="Calculate" , command=lambda: SWODIENT_Problema_4(v1.get(), v2.get(), v3.get(), v4.get(), v5.get(), v6.get())).grid(row=8)
master.mainloop()
