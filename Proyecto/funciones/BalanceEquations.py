...
Label(master, text="Volumen").grid(row=1)
Label(master, text="Concentration").grid(row=2)
Label(master, text="Temperature").grid(row=3)
v1 = StringVar()
v2 = StringVar()
v3 = StringVar()
...
Button(master, text="Calculate", command=lambda: BalanceEquations(v1.get(), v2.get(), v3.get())).grid(row=4)
mainloop()
