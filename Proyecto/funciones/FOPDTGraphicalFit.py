...
Label(master, text="Kp").grid(row=2)
Label(master, text="taup").grid(row=3)
Label(master, text="theta_p").grid(row=4)
...
Button(master, text="Calculate", command=lambda: FOPDTGraphicalFit(v1.get(), v2.get(), v3.get())).grid(row=5)
master.mainloop()
