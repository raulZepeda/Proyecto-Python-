...
Label(master, text="at time").grid(row=3)
Label(master, text="from u").grid(row=4)
Label(master, text="to u").grid(row=5)
v1 = StringVar()
v2 = StringVar()
v3 = StringVar()
v4 = StringVar()
...
Button(master, text="Calculate", command=lambda: SWODIENT_Problema_2(v1.get(), v2.get(), v3.get(), v4.get())).grid(row=6)
